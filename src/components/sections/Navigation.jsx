...
const Navigation = () => {
  ...
  return (
    <nav className="flex justify-between items-center pt-6 sm:pt-8 md:pt-10 lg:pt-[49px] pb-4 sm:pb-6 lg:pb-8 px-4 sm:px-6 md:px-12 lg:px-24 relative z-50">
      ...
      <div 
        className="relative w-[100px] sm:w-[120px] md:w-[140px] lg:w-[151px] h-[32px] sm:h-[38px] md:h-[44px] lg:h-[48px]"
        style={{ 
      ...
      {/* Navigation Links - Glass Effect Container - Frame 50 */}
      <div 
        className={`
          fixed lg:absolute top-0 left-0 right-0 bottom-0 
          lg:top-[40px] xl:top-[52px] lg:left-1/2 lg:-translate-x-1/2 lg:right-auto lg:bottom-auto
